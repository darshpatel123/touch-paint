...
var last_position_of_x, last_position_of_y;
    ...
    function my_touchmove(e){
     ...
     console.log("The current position of The mouse is ");
      ...
      console.log("x= "+current_position_of_mouse_x_t+"y= "+current_position_of_mouse_y_t);
     
      ctx.lineTo(current_position_of_mouse_x_t, current_position_of_mouse_y_t);
      ctx.stroke();
     last_position_of_x_t = current_position_of_mouse_x_t;
     last_position_of_y_t = current_position_of_mouse_y_t;
     ctx.beginPath();
